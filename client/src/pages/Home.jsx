...
export default function Home() {
  ...
  return (
    <div>
      ...
      <section className="py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-2xl font-bold text-airbnb-dark mb-8">Inspiration for future getaways</h2>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {[
              { label: 'Beach houses', emoji: '🏖️', query: 'Beachfront' },
              { label: 'Unique stays', emoji: '🌿', query: 'Countryside' },
              { label: 'Luxury villas', emoji: '✨', query: 'Luxury' },
              { label: 'Mountain cabins', emoji: '🏔️', query: 'Cabins' },
            ].map((item) => (
              <Link
                key={item.label}
